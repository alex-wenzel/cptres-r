### Version of analysis 12 except heatmap genes are
### ones that have > 0.25 avg expression in hvg.info
...
## Find genes with high average expression
avg.expr <- data.frame(
...
high.avg.expr.genes <- avg.expr[avg.expr$mean.expr>3.0,]$gene
