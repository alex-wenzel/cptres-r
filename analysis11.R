### Improvements on analysis10.R
###   --add cell cycle regression back (https://satijalab.org/seurat/cell_cycle_vignette.html)
###   --add bar in heatmap for Seurat::FindClusters results
...
## Subset the matrix with top variable genes
#expr.mat.var <- expr.mat[sc@var.genes,]
top.var.genes <- head(attr(sc@hvg.info$gene.dispersion.scaled, "dimnames")[[1]], 500)
